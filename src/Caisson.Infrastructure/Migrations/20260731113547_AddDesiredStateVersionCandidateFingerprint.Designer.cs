...
namespace Caisson.Infrastructure.Migrations
{
    ...
    [Migration("20260731113547_AddDesiredStateVersionCandidateFingerprint")]
    partial class AddDesiredStateVersionCandidateFingerprint
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Caisson.Domain.DesiredState.DesiredStateCandidateDiffCache", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("BaselineRevisionId")
                        .HasColumnType("uuid")
                        .HasColumnName("baseline_revision_id");

                    b.Property<string>("BaselineSha256")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character(64)")
                        .HasColumnName("baseline_sha256")
                        .IsFixedLength();
                    ...
                    b.Property<string>("CandidateSha256")
                        ...
                        .HasMaxLength(64)
                        .HasColumnType("character(64)")
                        .HasColumnName("candidate_sha256")
                        .IsFixedLength();
                    ...
                    b.Property<string>("RawUnifiedDiff")
                        .IsRequired()
                        .HasMaxLength(4194304)
                        .HasColumnType("text")
                        .HasColumnName("raw_unified_diff");

                    b.Property<string>("StructuredSummaryJson")
                        .IsRequired()
                        .HasMaxLength(2097152)
                        .HasColumnType("jsonb")
                        .HasColumnName("structured_summary_json");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_desired_state_candidate_diff_cache");

                    b.HasIndex("RackId", "ExpiresAtUtc")
                        .HasDatabaseName("ix_desired_state_candidate_diff_cache_rack_expires");

                    b.HasIndex("RackId", "BaselineRevisionId", "CandidateSha256")
                        .IsUnique()
                        .HasDatabaseName("ux_desired_state_candidate_diff_cache_rack_baseline_candidate");

                    b.ToTable("desired_state_candidate_diff_cache", (string)null);
                });
            ...
            modelBuilder.Entity("Caisson.Domain.Git.GitPullRequestLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_git_pull_request_link");

                    b.HasIndex("RackId", "CandidateFingerprint")
                        .IsUnique()
                        .HasDatabaseName("ux_git_pull_request_link_rack_fingerprint_open")
            ...
            modelBuilder.Entity("Caisson.Domain.DesiredState.DesiredStateCandidateDiffCache", b =>
                {
                    b.HasOne("Caisson.Domain.Topology.Rack", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_desired_state_candidate_diff_cache_racks_rack_id");
                });
