...
/// <summary>
/// Resolves an <see cref="IBmcDriverFactory"/> by its <see cref="DriverDescriptor"/>. Business logic
/// depends only on this interface, never on a concrete vendor factory type.
/// </summary>
public interface IBmcDriverRegistry
{
    ...
    bool TryResolve(DriverDescriptor query, [NotNullWhen(true)] out IBmcDriverFactory? factory);
}
