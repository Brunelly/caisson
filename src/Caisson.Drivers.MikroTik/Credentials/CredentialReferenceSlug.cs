...
/// TLS-config variable names can never drift apart. Public (not <c>internal</c>) so
/// <c>Caisson.Orchestration</c> — the one layer permitted to reference the concrete driver projects — can
/// reuse <see cref="Normalize"/> and <see cref="Validate"/> for configuration-wide collision detection.
/// </summary>
