...
/// redaction tests can scan the full output for secret material. It is also an <see cref="ILogger"/>, so it
/// can be passed straight to <c>RedfishClient</c>/<c>ProcessIpmiCommandRunner</c>.
/// </summary>
